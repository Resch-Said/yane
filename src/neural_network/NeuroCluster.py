...
from src.neural_network.YaneConfig import get_population_size, get_population_survival_rate
...
class NeuroCluster:
    def __init__(self):
        ...
        for i in range(get_population_size()):
            nn = NeuralNetwork()
    ...
    def regrow_population(self):
        while len(self.neural_networks) < get_population_size():
    ...
    def thin_out_population(self):
        ...
        for i in range(int(len(self.neural_networks) * get_population_survival_rate())):
